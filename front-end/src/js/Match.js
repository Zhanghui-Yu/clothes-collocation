                ...
                <View style={{height:width*1.46}}>
                   <ImageBackground style={{ flex: 1}} source={require('../img/background2.jpg')}>
                        ...
                        <TouchableOpacity onPress={() => {alert("上传成功");}}>
                                ...
                                <Text style={{ fontSize: 18,textAlign: 'center'}}>选择衣服</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                                   onPress={() => {alert("正在匹配");
                        ...
                        <Image source={require('../img/test4.png')} style={styles.logo} />
                   </ImageBackground >
                </View>
