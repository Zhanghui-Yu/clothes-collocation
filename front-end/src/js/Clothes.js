    ...
    render() {
        ...
        return (
            ...
            >
               ...
               <View style={{backgroundColor: '#F5FCFF',height:height*0.25}}>
                   <TouchableOpacity onPress={() => alert("上传图片")}>
                     <Image  source={require('../img/new.png')} style={styles.news}/>
                     <Text style={{ fontSize: 18,textAlign: 'center'}}>添加衣服</Text>
                   </TouchableOpacity>
               </View>
      ...
      renderMovie({ item }) {
        return (
            <View >
                  <Image source={require('../img/test1.jpg')}style={styles.thumbnail}/>
